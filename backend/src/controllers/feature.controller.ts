...
const SEED_FEATURES: SeedFeature[] = [
  ...
  { key: "ppt-generator", name: "PPT Generator", description: "Generate presentation decks from notes.", module: "Learning Hub", category: "Learning Hub", status: "Beta", environment: "Production", accessLevel: "Premium", version: "0.7.3", owner: "AI Team", isPremium: true, isBeta: true, apiEndpoint: "/api/ppt", rateLimit: 30, rolloutPct: 25, isEnabled: true, dependencies: ["ai-chat"] },
