...
const SEED_FEATURES: SeedFeature[] = [
  ...
  { key: "ppt-generator", name: "PPT Generator", description: "Generate presentation decks from notes.", module: "Learning Hub", category: "Learning Hub", status: "Enabled", environment: "Production", accessLevel: "All", version: "1.0.0", owner: "AI Team", isPremium: false, isBeta: false, apiEndpoint: "/api/ppt", rateLimit: 30, rolloutPct: 100, isEnabled: true, dependencies: ["ai-chat"] },
  ...
  { key: "career-roadmap", name: "Career Roadmap", description: "Personalized career progression roadmaps.", module: "Placement Hub", category: "Placement Hub", status: "Beta", environment: "Production", accessLevel: "All", version: "0.9.0", owner: "AI Team", isPremium: false, isBeta: true, apiEndpoint: "/api/career", rateLimit: 60, rolloutPct: 25, isEnabled: true, dependencies: ["ai-chat", "study-planner"] },
