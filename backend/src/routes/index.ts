...
import { presentationExportRouter } from "./presentation-export.routes";
...
apiRouter.use("/ppt/export", presentationExportRouter);
apiRouter.use("/export/ppt", presentationExportRouter);
